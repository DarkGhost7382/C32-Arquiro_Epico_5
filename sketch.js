...
//    var computerArcherCollision = Matter.SAT.collides( playerArrows[i].body, computerArcher.body );
...
//   if ( baseCollision.collided || playerCollision.collided|| playerArcherCollision.collided ) {
//     playerArcherLife -= 1;
//     player.reduceLife(playerArcherLife);
